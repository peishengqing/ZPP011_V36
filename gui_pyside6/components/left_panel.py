...
class LeftPanelComponent:
    ...
    def _create_panel(self):
        ...
        alt_btn_layout1.addWidget(add_btn)
        alt_btn_layout1.addWidget(del_btn)
        alt_btn_layout1.addWidget(reset_btn)
        alt_btn_layout1.addWidget(import_btn)
        alt_btn_layout1.addWidget(export_btn)
        alt_layout.addLayout(alt_btn_layout1)

        alt_btn_layout2 = QHBoxLayout()
        ...
        alt_btn_layout2.addWidget(sort_btn)
        alt_btn_layout2.addWidget(zoom_btn)
        alt_btn_layout2.addStretch()
        alt_layout.addLayout(alt_btn_layout2)
