...
VERSION_HISTORY = [
    {
        "version": "v39.4.1",
        "date": "2026-05-27",
        "build_datetime": "2026-05-27 11:48:00",
        "features": [
            "✨ 侧边栏替代料筛选修复：支持 _is_alt 列自动补充，布尔/字符串兼容",
            "✨ 数据加载时自动补充 _is_alt、audit_source、audit_status 三列",
            "✨ 审核来源/审核状态/校验提示筛选逻辑已集成（前端待后续版本启用）"
        ],
        "fixes": [
            "🐛 修复 filter_manager.py 缺少 C 常量导入导致的 NameError",
            "🐛 修复 filter_engine.py 中替代料列匹配逻辑（支持布尔值与字符串）",
            "🐛 修复侧边栏\"替代料=是/否\"筛选无效问题"
        ],
        "notes": [
            "📌 本版本主要解决替代料筛选失效问题，顶部筛选栏重复控件未清理",
            "📌 审核来源/审核状态/校验提示筛选前端控件待 v39.4.2 整合"
        ]
    },
    {
        "date": "2026-05-26",
